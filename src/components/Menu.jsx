...
const Menu = ({setMenu, arrow, description, type}) => {
...
if(type === 'city'){
    return(
        <div className="absolute text-white flex flex-col items-center justify-evenly top-14 w-1/3 rounded-br-lg rounded-bl-lg h-[250px] z-10 bg-gray-800">
